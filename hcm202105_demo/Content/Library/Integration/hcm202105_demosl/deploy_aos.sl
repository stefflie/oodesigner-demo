namespace: Integration.hcm202105_demosl
flow:
  name: deploy_aos
  inputs:
  ...
  graph:
    steps:
      ...
      install_aos_application:
        ...
        'y': 232
        navigate:
          e87cbdf0-4186-7823-8019-b061c1f75a30:
            targetId: 67800a62-dae6-800b-dfa9-ea47b358d373
            port: SUCCESS
    results:
      SUCCESS:
        67800a62-dae6-800b-dfa9-ea47b358d373:
          x: 929
          'y': 227
